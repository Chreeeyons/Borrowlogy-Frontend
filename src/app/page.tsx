...
export default function LandingPage() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-black text-white font-sans">
      {/* Hero Section */}
      <header
        className="hero flex items-center min-h-screen px-[5%] bg-cover bg-center"
        style={{ backgroundImage: "url('/images/hero-bg.png')" }}
      >
        <div className="hero-content text-left animate-fadeSlideIn opacity-100">
          {/* Title */}
          <h1 className="text-[8.5rem] font-bold font-jost mb-1 text-[#5E0708] text-shadow">
            Borrowlogy
          </h1>

          {/* Tagline */}
          <p className="tagline text-[1.8rem] font-normal mt-1 mb-1 text-[#5E0708]">
            Borrowing your Biology Lab Materials made easier!
          </p>

          {/* Introduction Text */}
          <p className="intro mt-6 text-[1.4rem] leading-8 max-w-[800px] text-left px-1 text-[#5E0708]">
